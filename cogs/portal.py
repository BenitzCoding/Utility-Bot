...
class Portal(commands.Cog):
	...
	async def distribute_message(self, message, server):
		if server == "Senarc":
			orion = discord.utils.get(self.bot.channels, utils.get_env("ORION_SC_ID"))
			orion_webhook = discord.utils.get(orion, name="Senarc Network Integration")
			mittens = discord.utils.get(self.bot.channels, utils.get_env("MITTENS_SC_ID"))
			mittens_webhook = discord.utils.get(mittens, name="Senarc Network Integration")
			secure = discord.utils.get(self.bot.channels, utils.get_env("SECURE_SC_ID"))
			secure_webhook = discord.utils.get(secure, name="Senarc Network Integration")
			mta = discord.utils.get(self.bot.channels, utils.get_env("MTA_SC_ID"))
		...
		if server == "Orion":
			senarc = discord.utils.get(self.bot.channels, utils.get_env("SENARC_SC_ID"))
	...
	async def on_message(self, message):
		...
		elif message.channel.id == utils.get_env("SECURE_SC_ID"):
			await self.distribute_message(message, "Secure")

		elif message.channel.id == utils.get_env("MTA_SC_ID"):
